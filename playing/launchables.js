...
const STATIC_GAMES = [
  ...
  { id: 'game-stk', name: 'SuperTuxKart', h2: 'A fun open-source racing game, with many mascots of open-source projects. (experimental)', path: './html/stk/index.html', img: './img/stk.png' },
